...
{
	$query = mysqli_query($koneksi,"SELECT sum(total_deaths) AS jumlah FROM tb_covid WHERE id='$bulan'");
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($koneksi,"SELECT sum(total_recovered) AS jumlah FROM tb_covid WHERE id='$bulan'");
	$row = $query->fetch_array();
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($koneksi,"SELECT sum(active_cases) AS jumlah FROM tb_covid WHERE id='$bulan'");
	$row = $query->fetch_array();
...
for($bulan = 1;$bulan < 11;$bulan++)
{
	$query = mysqli_query($koneksi,"SELECT sum(total_tests) AS jumlah FROM tb_covid WHERE id='$bulan'");
	$row = $query->fetch_array();
